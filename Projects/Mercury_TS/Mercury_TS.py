...
def check_camera(param, lib_dut):
    ...
    return lib_dut.check_camera(param)


def disconnect_camera(param, lib_dut):
    print('disconnect_camera input: {}'.format(param))

    return lib_dut.disconnect_camera(param)


def check_barcode_reader(param, lib_dut):
    print('check_barcode_reader input: {}'.format(param))

    return lib_dut.check_barcode_reader(param)


def disconnect_barcode_reader(param, lib_dut):
    print('disconnect_barcode_reader input: {}'.format(param))

    return lib_dut.disconnect_barcode_reader(param)


def check_microphone(param, lib_dut):
    print('check_microphone input: {}'.format(param))

    return lib_dut.check_microphone(param)


def disconnect_microphone(param, lib_dut):
    print('disconnect_microphone input: {}'.format(param))

    return lib_dut.disconnect_microphone(param)
...
def read_barcode(param, lib_dut):
    ...
    return lib_dut.read_barcode(param)
